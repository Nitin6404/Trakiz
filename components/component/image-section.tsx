      ...
      <div className="flex flex-col md:flex-row justify-between">
        <div className="md:mr-5">
          <h1 className="text-4xl font-bold text-center md:text-start text-zinc-500">
            WHY CHOOSE TRAKIZ <br /> AS{" "}
            <span className="text-[#ff8c00]">YOUR TODO PARTNER</span>
          </h1>
        </div>
        <div className="mt-4 md:mt-0 md:ml-5">
          <p className="text-center md:text-start text-zinc-500 max-w-2xl">
            We are committed to continuously enhancing <br /> our AI and
            features, ensuring you get the best <br /> productivity experience
        ...
        <div className="flex justify-center items-center">
          <Card className="flex flex-col justify-center items-center rounded-lg shadow-lg w-full max-w-sm h-[325px] bg-white text-black">
            ...
            <CardContent className="text-center text-lg text-gray-600 font-poppins">
              Say goodbye to boring lists! Chat with your tasks, get
              suggestions, & turn your to-do list into a productivity partner.
            </CardContent>
          </Card>
        </div>
        <div className="flex justify-center items-center">
          <Card className="flex flex-col justify-center items-center rounded-lg shadow-lg w-full max-w-sm h-[325px] bg-white text-black">
            ...
            <CardContent className="text-center text-lg text-gray-600 font-poppins">
              Trakiz helps you stay on track with focused timer sessions,
              boosting your productivity with short, effective sprints.
            </CardContent>
          </Card>
        </div>
        <div className="flex justify-center items-center">
          <Card className="flex flex-col justify-center items-center rounded-lg shadow-lg w-full max-w-sm h-[325px] bg-white text-black">
            ...
            <CardContent className="text-center text-lg text-gray-600 font-poppins">
              Track your progress with engaging charts and graphs. See how far
              you&apos;ve come.
            </CardContent>
          </Card>
        </div>
